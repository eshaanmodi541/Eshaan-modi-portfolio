...
Talcum powder is so small it should have been less than 80% accuracy at least for the cyclone. One thing I suspected was that the talcum powder was clumping. To combat this I may have to add some corn starch (\\<\1%) that should minimize clumping. 
